package com.chedaojunan.report.service;
...
public class ExternalApiExecutorService {
  ...
  private static ExecutorService executorService = Executors.newWorkStealingPool(Runtime.getRuntime().availableProcessors()*2);
//  private static ExecutorService executorService = Executors.newWorkStealingPool(16);
