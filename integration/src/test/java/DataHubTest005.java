...
public class DataHubTest005 {

  private static final Logger logger = LoggerFactory.getLogger(DataHubTest005.class);
  ...
  public void runDatahub(int i) {
    ...
    for (int m = 0; m < 10000; m++) {
      for (int j = 0; j < 30; j++) {
        ...
        accessData.setDeviceImei("test000005");
        accessData.setDeviceId("test000005" + j + "");
  ...
  public static void main(String[] args) {
    DataHubTest005 dataHubTest = new DataHubTest005();
    try {
      int i = 0;
//      while(true){
//        i++;
