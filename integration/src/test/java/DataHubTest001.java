...
public class DataHubTest001 {

  private static final Logger logger = LoggerFactory.getLogger(DataHubTest001.class);
  ...
  public void runDatahub(int i) {
    ...
    for (int m = 0; m < 10000; m++) {
      for (int j = 0; j < 30; j++) {
        ...
        accessData.setDeviceImei("test000001");
        accessData.setDeviceId("test000001" + j + "");
  ...
  public static void main(String[] args) {
    DataHubTest001 dataHubTest = new DataHubTest001();
    try {
      int i = 0;
//      while(true){
//        i++;
