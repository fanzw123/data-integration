...
public class KafkaProducerTest003 {

  private static final Logger logger = LoggerFactory.getLogger(KafkaProducerTest003.class);
  ...
  public void runProducer(String inputTopic) {
    ...
    for (int j = 1; j <= 200; j++) {
      ...
      gpsData.setDeviceImei("03test000"+j);
      gpsData.setDeviceId("03test000"+j);
      gpsData.setLocalTime("1521478861000");
      gpsData.setTripId("03test000");
  ...
  public static void main(String[] args) {
    KafkaProducerTest003 producerTest = new KafkaProducerTest003();
