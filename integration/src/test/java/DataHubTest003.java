...
public class DataHubTest003 {

  private static final Logger logger = LoggerFactory.getLogger(DataHubTest003.class);
  ...
  public void runDatahub(int i) {
    ...
    for (int m = 0; m < 10000; m++) {
      for (int j = 0; j < 30; j++) {
        ...
        accessData.setDeviceImei("test000003");
        accessData.setDeviceId("test000003" + j + "");
  ...
  public static void main(String[] args) {
    DataHubTest003 dataHubTest = new DataHubTest003();
    try {
      int i = 0;
//      while(true){
//        i++;
