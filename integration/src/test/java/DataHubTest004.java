...
public class DataHubTest004 {

  private static final Logger logger = LoggerFactory.getLogger(DataHubTest004.class);
  ...
  public void runDatahub(int i) {
    ...
    for (int m = 0; m < 10000; m++) {
      for (int j = 0; j < 30; j++) {
        ...
        accessData.setDeviceImei("test000004");
        accessData.setDeviceId("test000004" + j + "");
  ...
  public static void main(String[] args) {
    DataHubTest004 dataHubTest = new DataHubTest004();
    try {
      int i = 0;
//      while(true){
//        i++;
